...
public class Schema {
    ...
    public Schema withFields(List<Field> fields) {
        this.fields = fields;
        return this;
    }
    ...
    public Schema withOptional(Boolean optional) {
        this.optional = optional;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return ((((((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name)))&&((this.optional == rhs.optional)||((this.optional!= null)&&this.optional.equals(rhs.optional))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))))&&((this.fields == rhs.fields)||((this.fields!= null)&&this.fields.equals(rhs.fields))));
    }
